...
if __name__ == '__main__':
    ...
    while True:
        ...
        client.publish("yourusername/ip", ip_address)
        print("Publishing IP:", ip_address)
        ...
        client.publish("yourusername/date", date_str)
        print("Publishing Date:", date_str)

        client.publish("yourusername/time", time_str)
