...
REM
REM Generated by Vivado on Thu Oct 02 18:01:05 -0700 2025
...
echo "xvlog --incr --relax -prj ee354_GCD_SCEN_tb_v_vlog.prj"
call xvlog  --incr --relax -prj ee354_GCD_SCEN_tb_v_vlog.prj -log xvlog.log
