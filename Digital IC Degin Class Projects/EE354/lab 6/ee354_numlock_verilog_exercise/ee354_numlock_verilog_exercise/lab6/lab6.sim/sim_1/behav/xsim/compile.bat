...
REM
REM Generated by Vivado on Thu Sep 18 18:53:39 -0700 2025
...
echo "xvlog --incr --relax -prj ee354_numlock_sm_tb_vlog.prj"
call xvlog  --incr --relax -prj ee354_numlock_sm_tb_vlog.prj -log xvlog.log
