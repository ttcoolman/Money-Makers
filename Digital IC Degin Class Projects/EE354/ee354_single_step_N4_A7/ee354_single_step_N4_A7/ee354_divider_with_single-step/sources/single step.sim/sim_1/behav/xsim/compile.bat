...
REM
REM Generated by Vivado on Thu Sep 25 18:35:21 -0700 2025
...
echo "xvlog --incr --relax -prj divider_top_vlog.prj"
call xvlog  --incr --relax -prj divider_top_vlog.prj -log xvlog.log
