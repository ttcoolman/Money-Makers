...
// June 4, 2010, 9/18/2012, 1/20/2025 
...
wire  Qi_tb, Ql_tb, Qcmn_tb, Qcmxf_tb, Qcmx_tb, Qcmnf_tb, Qd_tb;
...
min_max_finder_part3_M1 UUT (Start_tb, Clk_tb, Reset_tb, 
				 Qi_tb, Ql_tb, Qcmn_tb, Qcmxf_tb, Qcmx_tb, Qcmnf_tb, Qd_tb, Min_tb, Max_tb);
				 
assign M_of_I = {UUT.M[UUT.I]}; // this is for displaying in waveform
				 
always @(*)
	begin
		case ({Qi_tb, Ql_tb, Qcmn_tb, Qcmxf_tb, Qcmx_tb, Qcmnf_tb, Qd_tb})
			7'b1000000: state_string = "INI ";
			7'b0100000: state_string = "LOAD";
			7'b0010000: state_string = "CMn";
			7'b0001000: state_string = "CMxF";
			7'b0000100: state_string = "CMx";
			7'b0000010: state_string = "CMnF";
...
task run_test;
	...
	begin
		...
		if (Qd_tb == 1) 
		   begin
		    $fdisplay (file_results, "Test number  %d: Min: %d decimal = %h hex   and   Max: %d decimal = %h hex.", test_numb, Min_tb, Min_tb, Max_tb, Max_tb);
		    $display ("Test number %d: Min: %d decimal = %h hex   and   Max: %d decimal = %h hex", test_numb, Min_tb, Min_tb, Max_tb, Max_tb);
...
endmodule  // min_max_finder_part3_M1_tb
