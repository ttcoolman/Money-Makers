...
wire  Qi_tb, Ql_tb, Qcmn_tb, Qcmx_tb, Qd_tb;
...
min_max_finder_part2 UUT (Start_tb, Clk_tb, Reset_tb, 
				 Qi_tb, Ql_tb, Qcmn_tb, Qcmx_tb, Qd_tb, Min_tb, Max_tb);
				 
assign M_of_I = {UUT.M[UUT.I]}; // this is for displaying in waveform
				 
always @(*)
	begin
		case ({Qi_tb, Ql_tb, Qcmn_tb, Qcmx_tb, Qd_tb})
			5'b10000: state_string = "INI ";
			5'b01000: state_string = "LOAD";
			5'b00100: state_string = "CMn";
			5'b00010: state_string = "CMx";
...
endmodule  // min_max_finder_part2_tb
