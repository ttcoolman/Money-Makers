...
// test #1 begin
	TEST_ALU (4'b0011, 4'b0010, 0, 0, 1); // (A,B,AINV,BNEG,Opr)  ADD
// test #1 end
...
// test #3 begin
	TEST_ALU (4'b0111, 4'b0001, 0, 0, 1); // (A,B,AINV,BNEG,Opr)  ADD
// test #3 end

// test #4 begin
	TEST_ALU (4'b1011, 4'b1100, 0, 0, 1); // (A,B,AINV,BNEG,Opr)  ADD
// test #4 end

// test #5 begin
	TEST_ALU (4'b1110, 4'b1101, 0, 1, 1); // (A,B,AINV,BNEG,Opr)  SUB
// test #5 end

// test #6 begin
	TEST_ALU (4'b0010, 4'b0100, 0, 1, 1); // (A,B,AINV,BNEG,Opr)  SUB
// test #6 end

// test #7 begin
	TEST_ALU (4'b1010, 4'b0100, 0, 1, 1); // (A,B,AINV,BNEG,Opr)  SUB
// test #7 end

// test #8 begin
	TEST_ALU (4'b0111, 4'b1001, 0, 1, 1); // (A,B,AINV,BNEG,Opr)  SUB
// test #8 end
